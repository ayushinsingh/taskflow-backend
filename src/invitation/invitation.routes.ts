...
import { invitationParamsSchema, invitationQuerySchema } from "./dto/invitation.schema.ts";
const invitationController = new InvitationController();
const router = Router();
router.get("/", invitationController.getInvitations.bind(invitationController));
router.post("/:id/accept", validate({params: invitationParamsSchema, query: invitationQuerySchema}), invitationController.acceptInvitation.bind(invitationController));
